...
export function MolecularField({ className = "" }: { className?: string }) {
  return (
    ...
    >
      <svg
        className="molecule-float-a absolute -left-8 top-[12%] w-[220px] md:w-[280px] opacity-[0.14] text-[#7a8fd4]"
        viewBox="0 0 200 160"
        fill="none"
      >
        <MoleculeA />
      ...
      <svg
        className="molecule-float-b absolute -right-10 top-[38%] w-[240px] md:w-[320px] opacity-[0.12] text-[#8b9ad9]"
        viewBox="0 0 200 160"
        fill="none"
      >
        <MoleculeB />
      ...
      <svg
        className="molecule-float-c absolute left-[18%] bottom-[8%] w-[200px] md:w-[260px] opacity-[0.10] text-[#7a8fd4]"
        viewBox="0 0 200 160"
        fill="none"
      >
        <MoleculeA />
      ...
      <svg
        className="molecule-waves absolute right-[8%] bottom-[18%] w-[280px] md:w-[380px] opacity-[0.11] text-[#a8b6e8]"
        viewBox="0 0 320 120"
        fill="none"
      >
        <WaveLines />
      ...
      <svg
        className="molecule-waves-slow absolute left-[5%] top-[55%] w-[240px] md:w-[300px] opacity-[0.08] text-[#8b9ad9]"
        viewBox="0 0 320 120"
        fill="none"
      >
        <WaveLines />
...
export function MoleculeMark({ className = "w-16 h-16" }: { className?: string }) {
  return (
    <svg className={`molecule-spin-slow text-[#7a8fd4]/35 ${className}`} viewBox="0 0 200 160" fill="none" aria-hidden>
      <MoleculeB />
    </svg>
  );
}
